        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    ...
                    <li><a class="waves-effect waves-light" href="bookings.php"><i class="fa fa-shopping-cart"></i> Bookings</a></li>
                    <li><a class="waves-effect waves-light" href="payment.php"><i class="fa fa-money"></i> Payments</a></li>
                    <li><a class="waves-effect waves-light" href="../index.php"><i class="fa fa-arrow-left"></i> Go to Homepage</a></li>
                ...
                <div class="nav navbar-nav navbar-right">
                    ...
                    <div class="dropdown user-profile right-icon">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="../logout.php" class="waves-effect waves-light">
